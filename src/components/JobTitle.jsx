...
const JobTitle = () => {
  return (
    <section className="flex flex-col px-20 pt-10 pb-8 border-b border-solid border-neutral-300">
      <div className="flex gap-4 px-5 flex-row items-center">
        ...
        <div className="flex gap-3 mt-2 font-medium">
          ...
          <div className="flex flex-row items-center -mt-1 gap-1 pr-2 pl-1.5 text-xs leading-5 text-center text-emerald-700 whitespace-nowrap bg-emerald-50 rounded-full border border-emerald-200 border-solid">
            <div className="size-1.5 bg-emerald-700 rounded-full"></div>
            <span className="mt-0.5">Open</span>
          </div>
        </div>
      </div>
      <div className="flex gap-1 items-center mt-6 text-xl font-medium text-zinc-500">
