...
const SidePanel = () => {
  return (
    <div className="flex flex-col px-6 pt-9 pb-20 mx-auto min-h-screen border-l border-r border-solid shadow-md bg-zinc-50 border-neutral-200 w-[409px]">
      ...
      <div className="flex flex-col p-3 mt-6 whitespace-nowrap rounded-md">
        <div className="flex gap-2 justify-between w-full">
          <div className="flex gap-2.5 p-2.5 text-base font-medium text-neutral-600">
            <Users />
            <div>Applicants</div>
          </div>
          <div className="my-auto text-xl p-2.5 font-semibold text-neutral-700">
            400
          </div>
        </div>
        ...
        <div className="shrink-0 mt-4 h-px bg-neutral-200" />
        <div className="flex gap-2 justify-between mt-4 w-full">
          <div className="flex gap-2 p-2.5 text-base font-medium text-neutral-600">
            <MessageSquare />
            <div>Messages</div>
          </div>
          <div className="my-auto text-xl p-2.5 font-semibold text-neutral-700">
